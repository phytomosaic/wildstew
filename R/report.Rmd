...
Over the most recent five year interval (relative to the preceding five years):  

Air quality is apparently \Large \textbf{`r aq_trend`} \normalsize.  

N deposition is apparently \Large \textbf{`r ndep_trend`} \normalsize.  

S deposition is apparently \Large \textbf{`r sdep_trend`} \normalsize.  
...
plot_trend(pick = rx(), yvar = 'n_raw_ex_sr_sens',
           ylab = 'N CL exceedance,\nsensitive species'); abline(h=0)
plot_trend(pick = rx(), yvar = 'n_raw_ex_compn',
           ylab = 'N CL exceedance,\ncomm composition'); abline(h=0)
```
...
plot_trend(pick = rx(), yvar = 's_raw_ex_sr_sens',
           ylab = 'S CL exceedance,\nsensitive species'); abline(h=0)
plot_trend(pick = rx(), yvar = 's_raw_ex_compn',
           ylab = 'S CL exceedance,\ncomm composition'); abline(h=0)
```
