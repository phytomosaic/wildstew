...
```{r plot-valuebar, fig.height=4.5, fig.width=6.0, fig.cap='Valuebar, showing observed N deposition from the CMAQ model, in relation to lichen-based critical loads.'}
...
`plot_valuebar` <- function(pick, ...){
    ...
    text(x=0.2, y=13.1, 'Acceptable', pos=1, cex=0.6)
    text(x=2.3, y=13.1, 'Marginal', pos=1, cex=0.6)
    text(x=4.6, y=13.1, 'Concerning', pos=1, cex=0.6)
    text(x=6.6, y=13.1, 'Poor', pos=1, cex=0.6)
    text(x=8.8, y=13.1, 'Very poor', pos=1, cex=0.6)
    arrows(obs, 9, obs, 1, length=0.20, angle=15, lwd=3, col=1)
